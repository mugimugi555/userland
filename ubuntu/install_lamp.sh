...
# ======================================================================================================================
sudo apt install -y apache2 mariadb-server php php-cli libapache2-mod-php php-mysql php-gd php-imap php-ldap php-xml php-curl php-mbstring php-zip phpmyadmin
php -v ;
